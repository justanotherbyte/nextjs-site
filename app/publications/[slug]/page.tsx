...
export default async function RenderedPublication({
  params,
}: {
  ...
  return (
    <div>
      ...
      ></link>
      <h1 className="dark:text-white text-lg font-semibold mb-2">
        {article.title}
      </h1>
