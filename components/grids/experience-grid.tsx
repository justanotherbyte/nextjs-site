...
export async function generateStaticParams() {
    const experiences = await pool.query(`SELECT id FROM experience ORDER BY id DESC LIMIT 1`);
...
export default async function ExperienceGrid() {
    const query = await pool.query(`SELECT * FROM experience ORDER BY id DESC LIMIT 1`);
